 ...
 *
 * NOTEZ-BIEN : 
 * - you MUST costumize the 2 defines on the top as per your own
 * setup.
 * - obviously, the token has been removed as soon as my tests were over :)
 *
 *	GPLv3
 *
 * Compiling : gcc test_curl.c -o test_curl -lcurl
 */
...
#define TARGET_URL "https://gateway-2303-1738-7152.local:8443/enduser-mobile-web/1/enduserAPI/setup"

// Define the Bearer Token (Test only)
#define BEARER_TOKEN "690e6dc6b494cbbb7d26" 
